            ...
            <form onSubmit={submitHandler}>
              ...
              <div className='mb-5 flex items-center justify-between'>
                ...
                {/* <label className='text-headingColor font-bold text-[16px] leading-7 px-4 py-3 focus:outline-none'>
                  ...
                  <p className='text-red-700 text-[10px]'>*For Hospitals Not Applicable</p>
                </label>
                <label className='text-headingColor font-bold text-[16px] leading-7 px-4 py-3 focus:outline-none'>
                  Location
                  <select name="location" value={formData.location} onChange={handleInputChange} className='text-textColor font-semibold text-[15px] leading-7 px-4 py-3 focus:outline-none'>
